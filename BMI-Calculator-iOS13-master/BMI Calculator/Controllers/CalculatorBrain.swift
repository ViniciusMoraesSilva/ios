...
//  BMI Calculator
//
//  Created by Vinicius Moraes on 14/05/23.
...
struct CalculatorBrain {
    ...
    mutating func calculateBMI(height: Float, weight: Float) {
        ...
        if bmiValue < 18.5 {
            ...
            bmi = BMI(value: bmiValue, advice: "Eat more pies", color: #colorLiteral(red: 0.6090133786, green: 0.1111216322, blue: 0.1188362613, alpha: 1))
        }
    }
